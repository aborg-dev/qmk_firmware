...
const uint16_t PROGMEM escape_combo[] = {CTL_T(KC_J), SFT_T(KC_K), COMBO_END};
combo_t key_combos[] = {
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QW] = LAYOUT( /* Qwerty */
      ...
      KC_ESC,          KC_NO,       KC_NO,           KC_NO,           LT(_NAV, KC_ENT), KC_UNDS, KC_TAB,  KC_SPC, KC_NO,          CW_TOGG,         OSL(_NUM),       KC_NO),
   ...
   */
  [_NAV] = LAYOUT( /* [> NAV <] */
    KC_INS,  _______, _______, _______, KC_LANG,                    KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_F10  ,
    KC_BSPC, _______, _______, _______, _______,                    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_F11  ,
